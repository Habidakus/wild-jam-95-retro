class_name ShotgunBullet extends Bullet
...
func initialize(board: Board, dir: Vector2) -> void:
	_board = board
	_direction = dir
...
func _physics_process(delta: float) -> void:
	var velocity: Vector2 = _direction * SPEED * delta * _board.get_time_dilation()
